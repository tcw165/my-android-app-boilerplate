...
#include <my/rgb2yuv.h>
#include <my/yuv2rgb.h>
...
IMAGEUTILS_METHOD(convertYUV420SPToARGB8888)(JNIEnv *env,
                                             jclass clazz,
                                             jbyteArray input,
                                             jintArray output,
                                             jint width,
...
JNIEXPORT void JNICALL
IMAGEUTILS_METHOD(convertYUV420ToARGB8888)(JNIEnv *env,
                                           jclass clazz,
                                           jbyteArray y,
                                           jbyteArray u,
                                           jbyteArray v,
...
JNIEXPORT void JNICALL
IMAGEUTILS_METHOD(convertYUV420SPToRGB565)(JNIEnv *env,
                                           jclass clazz,
                                           jbyteArray input,
                                           jbyteArray output,
                                           jint width,
