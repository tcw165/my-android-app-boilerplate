...
#define IMAGEUTILS_METHOD(METHOD_NAME) \
  Java_org_tensorflow_contrib_android_ImageUtils_##METHOD_NAME  // NOLINT

#ifdef __cplusplus
extern "C" {
#endif

JNIEXPORT void JNICALL IMAGEUTILS_METHOD(convertYUV420SPToARGB8888)(JNIEnv *env,
                                                                    jclass clazz,
                                                                    jbyteArray input,
                                                                    jintArray output,
                                                                    jint width,
...
JNIEXPORT void JNICALL IMAGEUTILS_METHOD(convertYUV420ToARGB8888)(JNIEnv *env,
                                                                  jclass clazz,
                                                                  jbyteArray y,
                                                                  jbyteArray u,
                                                                  jbyteArray v,
...
JNIEXPORT void JNICALL IMAGEUTILS_METHOD(convertYUV420SPToRGB565)(JNIEnv *env,
                                                                  jclass clazz,
                                                                  jbyteArray input,
                                                                  jbyteArray output,
                                                                  jint width,
...
JNIEXPORT void JNICALL IMAGEUTILS_METHOD(convertARGB8888ToYUV420SP)(JNIEnv *env,
                                                                    jclass clazz,
                                                                    jintArray input,
                                                                    jbyteArray output,
                                                                    jint width,
...
JNIEXPORT void JNICALL IMAGEUTILS_METHOD(convertRGB565ToYUV420SP)(JNIEnv *env,
                                                                  jclass clazz,
                                                                  jbyteArray input,
                                                                  jbyteArray output,
                                                                  jint width,
...
IMAGEUTILS_METHOD(convertARGB8888ToYUV420SP)(JNIEnv *env,
                                             jclass clazz,
                                             jintArray input,
                                             jbyteArray output,
                                             jint width,
...
JNIEXPORT void JNICALL
IMAGEUTILS_METHOD(convertRGB565ToYUV420SP)(JNIEnv *env,
                                           jclass clazz,
                                           jbyteArray input,
                                           jbyteArray output,
                                           jint width,
