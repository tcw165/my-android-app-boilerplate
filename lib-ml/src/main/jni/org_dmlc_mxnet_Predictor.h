...
Java_org_dmlc_mxnet_Predictor_createPredictor(JNIEnv*,
                                              jclass,
                                              jbyteArray,
                                              jbyteArray,
                                              jint,
...
Java_org_dmlc_mxnet_Predictor_nativeFree(JNIEnv*,
                                         jclass,
                                         jlong);
...
Java_org_dmlc_mxnet_Predictor_nativeGetOutput(JNIEnv*,
                                              jclass,
                                              jlong,
                                              jint);
 ...
 */
JNIEXPORT void JNICALL
Java_org_dmlc_mxnet_Predictor_nativeForward(JNIEnv*,
                                            jclass,
                                            jlong,
                                            jstring,
                                            jfloatArray);
