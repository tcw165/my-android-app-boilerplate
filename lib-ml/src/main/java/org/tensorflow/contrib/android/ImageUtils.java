...
public class ImageUtils {
     ...
     */
    @SuppressWarnings("unused")
    public static int getYUVByteSize(final int width,
                                     final int height) {
    ...
    public static void saveBitmap(final Bitmap bitmap,
        ...
        sLOGGER.i("Saving %dx%d bitmap to %s.", bitmap.getWidth(), bitmap.getHeight(), root);
        final File myDir = new File(root);

        if (!myDir.mkdirs()) {
            sLOGGER.i("Make dir failed");
        }
     ...
     */
    @SuppressWarnings("unused")
    public static native void convertYUV420SPToARGB8888(byte[] input,
                                                        int[] output,
                                                        int width,
                                                        int height,
                                                        boolean halfSize);
     ...
     */
    @SuppressWarnings("unused")
    public static native void convertYUV420ToARGB8888(byte[] y,
                                                      byte[] u,
                                                      byte[] v,
                                                      int[] output,
                                                      int width,
     ...
     */
    @SuppressWarnings("unused")
    public static native void convertYUV420SPToRGB565(byte[] input,
                                                      byte[] output,
                                                      int width,
                                                      int height);
     ...
     */
    @SuppressWarnings("unused")
    public static native void convertARGB8888ToYUV420SP(int[] input,
                                                        byte[] output,
                                                        int width,
                                                        int height);
     ...
     */
    @SuppressWarnings("unused")
    public static native void convertRGB565ToYUV420SP(byte[] input,
                                                      byte[] output,
                                                      int width,
                                                      int height);
